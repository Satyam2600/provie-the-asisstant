...
def mainbrain(query):
  ...
  if "hi there " in query:
    speak("hi sir , how are you ?")
  
  elif "bye" in query:
    speak("alright sir , have a great day !")
  elif "how are you" in query:
    speak("am  fine , thanks for asking !")
  elif "who am i" in query:
   speak("okay so , Your name is satyam , pretty much into editing and stuff ! you also love valorant but nevermind , you know its not  the same as it was ")
  elif "confused" in query:
    speak("why ? may i help you ?")
  elif   "  you know it is  my friend's birthday today" in query:
    speak("wow , thats beautiful , whats his name ")
  elif "rachit" in query:
    speak(" a very very happy birthday to your friend rachit")
  elif "a birthday song" in query:
     speak("happy birthday to youuuuuuuuuuu , happy birthday to youuuuuuuu , happy birthday happy birthday , happy birthday  to u , happy birthday to u rachit")
  elif "time" in query:
...
intents = {
    ...
    "time": {
        ...
        "responses": ["The current time is [current_time].", "Right now, it's [current_time]."]
    },
    "jokes": {
    ...
    "movies": {
        ...
        "responses": ["How about watching 50 shades of grey ?", "Here's a movie suggestion for you.", "Let me recommend some great movies!"]
    },
    "sports": {
    ...
    "carings": {
        "patterns": ["how are you ", "how are you doing today ", " how are u sweetie", "how are u pookie "],
        "responses": [" i am all good , how about you ? ", " am fine sweetheart , thanks for asking ", " your pookie is all good  just take care of yourself"]
    },
    "about_owner": {
        "patterns": ["who created you  ", "whos behind your creation", " who is your creator ", "tell me about your creator "],
        "responses": [" am created by you dumbass satyam , well ya u just started working on me right now  but ya its u always behind me  ", " i am created by this eighteen years old dumbfuck teen , satyam ", " Satyam  , satyam is the name of my creator not actually but ya he did work on me a lot "]
    },
   "rizz": {
     "patterns": ["can u rizz me up ", "show me your flirting skills " , "flirt mode on" , "turn romantic" "another line"],
     "responses" : ["If beauty were time, you'd be an eternity." , "Do you have a sunburn, or are you always this hot?" ,"Are you a camera? Because every time I see you, I smile.", "If you were a cat, you'd purr-fect.", "Is your name Google? Because you've got everything I've been searching for." , "If you were a vegetable, you'd be a cute-cumber!", "Can I follow you home? Because my parents always told me to follow my dreams."]
   } ,
    "dirty talks": {
     "patterns": ["talk dirty to me  ", "dirty talk pls " , "go dirty with me " ,],
     "responses" : ["sure daddy ! my pussy is always ready for u " , " ofcourse daddy , here only or on bed ?" ," daddy chill ",]
   } ,
}
...
vectorizer=TfidfVectorizer(tokenizer=nltk.word_tokenize,stop_words="english",max_df=1.0,min_df=0.0)
...
speak(" Hi sweetie , provi here ! How can I assist you?")
...
while True:
    ...
    if intent in intents:
        ...
        speak("Provie: Sorry, I'm not sure how to respond to that.")
